...
SEXP crossprod_naive_C(SEXP s_x)
{
    ...
    if (Rf_isComplex(s_x)) {
        error("crossprod_naive_C: complex x not implemented yet");
        
    } else if (Rf_isInteger(s_x)) {
        error("crossprod_naive_C: integer x not implemented yet");
        
    } else if (!Rf_isReal(s_x) && !Rf_isInteger(s_x)) {
        error("crossprod_naive_C: wrong x type");
    }
    ...
    if (Rf_isNull(s_dims)) {
        error("crossprod_naive_C: no dimensions");
    }
    ...
    if (dimCount != 2) {
        error("crossprod_naive_C: wrong dimension");
    }
...
SEXP crossprod_blas_C(SEXP s_x)
{
    ...
    if (Rf_isComplex(s_x)) {
        error("crossprod_blas_C: complex x not implemented yet");
        
    } else if (Rf_isInteger(s_x)) {
        error("crossprod_blas_C: integer x not implemented yet");
        
    } else if (!Rf_isReal(s_x) && !Rf_isInteger(s_x)) {
        error("crossprod_blas_C: wrong x type");
    }
    ...
    if (Rf_isNull(s_dims)) {
        error("crossprod_blas_C: no dimensions");
    }
    ...
    if (dimCount != 2) {
        error("crossprod_blas_C: wrong dimension");
    }
    ...
    if (isFloat) {
        ...
        if (inMatrix == nullptr || outMatrix == nullptr) {
            error("crossprod_blas_C: insufficient memory");
...
SEXP crossprod_clblas_C(SEXP s_device, SEXP s_x)
{
    ...
    
    {
        ...
        if (!Rf_isNull(deviceClass) && strcmp("opencl.device", CHAR(STRING_ELT(deviceClass, 0))) != 0) {
            error("crossprod_clblas_C: wrong device class");
        }
    ...
    if (Rf_isComplex(s_x)) {
        error("crossprod_clblas_C: complex x not implemented yet");
        
    } else if (Rf_isInteger(s_x)) {
        error("crossprod_clblas_C: integer x not implemented yet");
        
    } else if (!Rf_isReal(s_x) && !Rf_isInteger(s_x)) {
        error("crossprod_clblas_C: wrong x type");
    }
    ...
    if (Rf_isNull(s_dims)) {
        error("crossprod_clblas_C: no dimensions");
    }
    ...
    if (dimCount != 2) {
        error("crossprod_clblas_C: wrong dimension");
    }
    ...
    if (device_id == nullptr) {
        error("crossprod_clblas_C: null cl_device_id");
    }
