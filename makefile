...
obj/main.o: multiBLAS.XC/multiBLAS.XC/main.cpp $(HEADERS)
    ...
    -I/opt/clBLAS-2.4.0-Linux-x64/lib64/include/ -I/usr/local/clblas/include -DRPACKAGE=0  -std=c++11
...
obj/multiblas_gemm.o: multiblas/src/multiblas_gemm.cpp $(HEADERS)
    ...
    -I/opt/clBLAS-2.4.0-Linux-x64/lib64/include/ -I/usr/local/clblas/include -DRPACKAGE=0
