...
obj/multiblas_gemm.o: multiblas/src/multiblas_gemm.cpp $(HEADERS)
    ...
    -I/opt/clBLAS-2.4.0-Linux-x64/include/ -I/usr/local/clblas/include -DRPACKAGE=0 -Dnullptr='NULL'
...
obj/gemm_blas.o: multiblas/src/gemm_blas.cpp $(HEADERS)
	g++ -o obj/gemm_blas.o -c multiblas/src/gemm_blas.cpp -Imultiblas/src -I/usr/lib64/openblas/include/ -DRPACKAGE=0 -Dnullptr='NULL'
...
obj/gemm_opencl.o: multiblas/src/gemm_opencl.cpp $(HEADERS)
	g++ -o obj/gemm_opencl.o -c multiblas/src/gemm_opencl.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0 -Dnullptr='NULL'

obj/gemm_naive.o: multiblas/src/gemm_naive.cpp $(HEADERS)
	g++ -o obj/gemm_naive.o -c multiblas/src/gemm_naive.cpp -Imultiblas/src -DRPACKAGE=0 -Dnullptr='NULL'
...
obj/crossprod_blas.o: multiblas/src/crossprod_blas.cpp $(HEADERS)
	g++ -o obj/crossprod_blas.o -c multiblas/src/crossprod_blas.cpp -Imultiblas/src -I/usr/lib64/openblas/include/ -DRPACKAGE=0 -Dnullptr='NULL'
