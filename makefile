...
obj/gemm_opencl.o: multiblas/src/gemm_opencl.cpp $(HEADERS)
	g++ -o obj/gemm_opencl.o -c multiblas/src/gemm_opencl.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0
...
obj/crossprod_opencl.o: multiblas/src/crossprod_opencl.cpp $(HEADERS)
	g++ -o obj/crossprod_opencl.o -c multiblas/src/crossprod_opencl.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0
...
obj/multiblas.o: multiblas/src/multiblas.cpp $(HEADERS)
	g++ -o obj/multiblas.o -c multiblas/src/multiblas.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0

obj/opencl_info.o: multiblas/src/opencl_info.cpp $(HEADERS)
	g++ -o obj/opencl_info.o -c multiblas/src/opencl_info.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0
