...
obj/multiblas.o: multiblas/src/multiblas.cpp $(HEADERS)
	g++ -o obj/multiblas.o -c multiblas/src/multiblas.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0/include -DRPACKAGE=0 -std=c++11

obj/opencl_info.o: multiblas/src/opencl_info.cpp $(HEADERS)
	g++ -o obj/opencl_info.o -c multiblas/src/opencl_info.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0/include -DRPACKAGE=0 -std=c++11
