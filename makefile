...
obj/gemm_blas.o: multiblas/src/gemm_blas.cpp $(HEADERS)
	g++ -o obj/gemm_blas.o -c multiblas/src/gemm_blas.cpp -Imultiblas/src -I/usr/lib64/openblas/include/ -DRPACKAGE=0 -std=c++11
...
obj/gemm_opencl.o: multiblas/src/gemm_opencl.cpp $(HEADERS)
	g++ -o obj/gemm_opencl.o -c multiblas/src/gemm_opencl.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0 -std=c++11

obj/gemm_naive.o: multiblas/src/gemm_naive.cpp $(HEADERS)
	g++ -o obj/gemm_naive.o -c multiblas/src/gemm_naive.cpp -Imultiblas/src -DRPACKAGE=0 -std=c++11

obj/multiblas_crossprod.o: multiblas/src/multiblas_crossprod.cpp $(HEADERS)
	g++ -o obj/multiblas_crossprod.o -c multiblas/src/multiblas_crossprod.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include \
    -I/opt/clBLAS-2.12.0-Linux-x64/include/ -I/usr/local/clblas/include -DRPACKAGE=0 -std=c++11
...
obj/crossprod_blas.o: multiblas/src/crossprod_blas.cpp $(HEADERS)
	g++ -o obj/crossprod_blas.o -c multiblas/src/crossprod_blas.cpp -Imultiblas/src -I/usr/lib64/openblas/include/ -DRPACKAGE=0 -std=c++11

obj/crossprod_clblas.o: multiblas/src/crossprod_clblas.cpp $(HEADERS)
	g++ -o obj/crossprod_clblas.o -c multiblas/src/crossprod_clblas.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include \
    -I/opt/clBLAS-2.12.0-Linux-x64/include/ -I/usr/local/clblas/include -DRPACKAGE=0 -std=c++11

obj/crossprod_opencl.o: multiblas/src/crossprod_opencl.cpp $(HEADERS)
	g++ -o obj/crossprod_opencl.o -c multiblas/src/crossprod_opencl.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0 -std=c++11

obj/crossprod_naive.o: multiblas/src/crossprod_naive.cpp $(HEADERS)
	g++ -o obj/crossprod_naive.o -c multiblas/src/crossprod_naive.cpp -Imultiblas/src -DRPACKAGE=0 -std=c++11

obj/multiblas.o: multiblas/src/multiblas.cpp $(HEADERS)
	g++ -o obj/multiblas.o -c multiblas/src/multiblas.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0 -std=c++11

obj/opencl_info.o: multiblas/src/opencl_info.cpp $(HEADERS)
	g++ -o obj/opencl_info.o -c multiblas/src/opencl_info.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0 -std=c++11

obj/shim.o: multiblas/src/shim.cpp $(HEADERS)
	g++ -o obj/shim.o -c multiblas/src/shim.cpp -Imultiblas/src -DRPACKAGE=0 -std=c++11

obj/utils_clblas.o: multiblas/src/utils_clblas.cpp $(HEADERS)
	g++ -o obj/utils_clblas.o -c multiblas/src/utils_clblas.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include \
    -I/opt/clBLAS-2.12.0-Linux-x64/include/ -I/usr/local/clblas/include -DRPACKAGE=0 -std=c++11

obj/utils.o: multiblas/src/utils.cpp $(HEADERS)
	g++ -o obj/utils.o -c multiblas/src/utils.cpp -Imultiblas/src -I/opt/AMDAPPSDK-3.0-0-Beta/include -DRPACKAGE=0 -std=c++11
